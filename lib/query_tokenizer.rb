...
class QueryTokenizer
  def tokenize(str)
    ...
    until s.eos?
      ...
      elsif s.scan(/(is|not):(vanilla|spell|permanent|funny|timeshifted|colorshifted|reserved|multipart|promo|primary|commander|digital|reprint)\b/i)
