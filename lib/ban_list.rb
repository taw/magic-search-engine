...
DynamicBanListData = {
  ...
  "standard" => {
    ...
    "Mind Over Matter"        => { "jun 1996" => "banned" },
  ...
  "vintage" => {
    ...
    "Candelabra of Tawnos"    => { "may 1994" => "restricted" },
    "Chalice of the Void"     => { "bfz"=>"restricted" },
    "Channel"                 => { "may 1994" => "restricted", "?" => "banned", "sep 2000" => "restricted" },
    "Chrome Mox"              => { "dec 2003" => "restricted", "sep 2008" => "legal" },
    "Copy Artifact"           => { "may 1994" => "restricted" },
    ...
    "Feldon's Cane"           => { "may 1994" => "restricted" },
    ...
    "Ivory Tower"             => { "may 1994" => "restricted" },
    ...
    "Time Twister"            => { "start" => "restricted" },
    "Time Vault"              => { "start" => "restricted", "mar 1994" => "banned", "mar 1996" => "legal", "sep 2008" => "restricted" },
