...
class QueryTokenizer
  def tokenize(str)
    ...
    until s.eos?
      ...
      elsif s.scan(/(is|not)[:=](vanilla|spell|permanent|funny|timeshifted|colorshifted|reserved|multipart|promo|primary|commander|digital|reprint|fetchland|shockland|dual|fastland|bounceland|gainland|filterland|checkland|manland|scryland|battleland|augment|custom)\b/i)
