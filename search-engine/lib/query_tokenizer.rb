...
class QueryTokenizer
  def tokenize(str)
    ...
    until s.eos?
      ...
      elsif s.scan(/has:(partner|watermark|indicator|showcase|boosterfun)\b/)
        cond = s[1].capitalize
