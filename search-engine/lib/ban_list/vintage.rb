BanList.for_format("vintage") do
  ...
  format_start(
    ...
    "Braingeyser" => "restricted",
    "Dingus Egg" => "restricted",
    "Gauntlet of Might" => "restricted",
    "Icy Manipulator" => "restricted",
    "Mox Emerald" => "restricted",
    "Mox Jet" => "restricted",
    "Mox Pearl" => "restricted",
    "Mox Ruby" => "restricted",
    "Mox Sapphire" => "restricted",
    "Orcish Oriflamme" => "restricted",
    "Rukh Egg" => "restricted",
    "Sol Ring" => "restricted",
  ...
  change(
    ...
    "Rukh Egg" => "legal",
    "Candelabra of Tawnos" => "restricted",
    "Channel" => "restricted",
    "Copy Artifact" => "restricted",
    "Demonic Tutor" => "restricted",
    "Feldon's Cane" => "restricted",
  ...
  change(
    ...
    "Enlightened Tutor" => "restricted",
    "Frantic Search" => "restricted",
    "Grim Monolith" => "restricted",
    "Hurkyl's Recall" => "restricted",
    "Lotus Petal" => "restricted",
    "Mana Crypt" => "restricted",
    "Mana Vault" => "restricted",
    "Mind Over Matter" => "restricted",
    "Mox Diamond" => "restricted",
    "Mystical Tutor" => "restricted",
    "Tinker" => "restricted",
    "Vampiric Tutor" => "restricted",
    "Voltaic Key" => "restricted",
  ...
  change(
    ...
    "Entomb" => "legal",
    "Grim Monolith" => "legal",
    "Thirst for Knowledge" => "restricted",
  )
