describe "Formats" do
  ...
  it "formats" do
    ...
    assert_search_equal "f:standard",
      %Q[(e:kld or e:aer or e:akh or e:w17 or e:hou or e:xln or e:rix) -"Smuggler's Copter" -"Felidar Guardian" -"Aetherworks Marvel" -"Attune with Aether" -"Rogue Refiner" -"Rampaging Ferocidon" -"Ramunap Ruins"]
