# This spec is a constant source of annoyance due to more and more complicated logic in recent sets
# Going forward I'll just trust mtgjson, as these errors are not that important anyway
# I might restore a limited subset of it at some point
...
#         assert_foiling(promo_cards, "foilonly")
#         assert_foiling(regular_cards, "both")
#       when "afr", "afc", "mid", "mic", "znc", "c21", "vow", "voc", "klr", "akr", "neo", "nec", "slx", "snc", "ncc"
