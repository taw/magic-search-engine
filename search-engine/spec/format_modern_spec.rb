describe "Formats - Modern" do
  ...
  it "modern" do
    assert_block_composition "modern", "war", ["8ed", "mrd", "dst", "5dn", "chk", "bok", "sok", "9ed", "rav", "gpt", "dis", "csp", "tsp", "tsb", "plc", "fut", "10e", "lrw", "mor", "shm", "eve", "ala", "con", "arb", "m10", "zen", "wwk", "roe", "m11", "som", "mbs", "nph", "m12", "isd", "dka", "avr", "m13", "rtr", "gtc", "dgm", "m14", "ths", "bng", "jou", "m15", "ktk", "frf", "dtk", "ori", "bfz", "ogw", "soi", "emn", "kld", "aer", "akh", "w17", "hou", "xln", "rix", "dom", "m19", "grn", "rna", "war"],
      "Ancient Den" => "banned",
      "Birthing Pod" => "banned",
