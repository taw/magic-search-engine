...
describe "Old templates" do
  ...
  it do
    assert_count_results %Q[o:"mana pool"], 3
  end

  it do
    # "Firesong and Sunspeaker" is an exception
    assert_count_results %Q[o:"creature or player"], 2
  end
  ...
  it do
    # Gifts Given
    assert_count_results %Q[o:"his or her"], 1
    assert_count_results %Q[o:"he or she"], 0
