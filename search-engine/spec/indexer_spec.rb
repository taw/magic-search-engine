describe "Indexer hacks" do
  ...
  it "is:funny" do
    assert_search_equal_cards "is:funny", "e:unh,ugl,uqc,hho,ust,pust,ppc1,htr,htr17,h17,tbth,tdag,tfth,thp1,thp2,thp3 -t:basic -(Steamflogger Boss) -(Hall of Triumph)"
  end
