...
class PatchSetTypes < Patch
  def call
    each_set do |set|
      ...
      funny_sets = %W[unh ugl pcel hho parl prel ust pust ppc1 htr htr16 htr17 htr18 htr19 htr20 pal04 h17 j17 tbth tdag tfth thp1 thp2 thp3 ptg cmb1 cmb2 htr18 und punh plist plst o90p olep p30a uplist ulst phtr ph17 ph18 ph19 ph20 ph21 ph22 p30m sch]
